  	...
  	<div class="row content">
        ...
        <div class="col-xs-offset-1 col-md-offset-1 col-md-3">    
          ...
          <div class="panel panel-success">
            <div class="panel-heading secondo-contenuto">
						<button type="button" class=" btn btn-md btn-default" data-toggle="modal" data-target="#myModal">Crea utente</button></li>
           	<button type="button" class=" btn btn-md btn-default" data-toggle="modal" data-target="#myModal">Crea sala</button></li>




            	<h5 class="caratteristiche-titolo text-center">Eventi della sala</h5></div>
