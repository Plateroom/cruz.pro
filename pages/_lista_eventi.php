...
<div class="container-fluid">
   ...
   <div class="row content-img">
        ...
        <div class="col-md-7">
          <div class="panel panel-danger" id="list-pannel-2">
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg" id="Apri-2">Apri</button>
...
<div class="row content-img">
        ...
        <div class="col-md-7">
          <div class="panel panel-danger" id="list-pannel-3">
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg" id="Apri-3">Apri</button>
...
<nav>
  <ul class="pager ">
    <li class="previous"><a href="#"><span aria-hidden="true">&larr;</span> Precedente</a></li>
    <li class="next"><a href="#">seguente <span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
